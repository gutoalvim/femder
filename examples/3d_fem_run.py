...
import femder as fd
import numpy as np
path_to_geo = r"C:\Users\gutoa\Documents\SkaterXL\UFSM\MNAV\Code Testing\CR2.geo"
# path_to_geo = "..\\Mshs\\FEM_3D\\cplx_room.brep"
# path_to_geo = r'C:\Users\gutoa\Documents\SkaterXL\UFSM\Estagio\Virtual Goniometer\Mshs\hemisphere_30cm.IGS'
...
BC = fd.BC(AC,AP)
BC.normalized_admittance(2,0.01)
...
# # BC.rigid(2)
# #%%
# grid = fd.GridImport3D(AP,path_to_geo,S=None,R=None,fmax = 250,num_freq=6,scale=1,order=1,plot=True)
